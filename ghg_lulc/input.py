...
class ComputeInput(BaseModel):
    ...
    classification_threshold: Optional[confloat(ge=0,
                                                le=100)] = Field(title='Minimum required classification confidence [%]',
                                                                 ...
                                                                 examples=[75],
                                                                 default=75)
    ghg_stock_source: Optional[GhgStockSource] = Field(title='Literature Source for LULC GHG stock values',
